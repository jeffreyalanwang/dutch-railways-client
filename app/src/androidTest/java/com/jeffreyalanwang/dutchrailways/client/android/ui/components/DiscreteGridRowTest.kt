...
class DiscreteGridRowTest {
    ...
    @Test
    fun `cellAlign update should reposition item`() = runComposeUiTest {
        ...
        fun assertLeft(expected: Float) {
            val actual = onNodeWithTag("item").getUnclippedBoundsInRoot().left.value
    ...
    @Test
    fun `fill should take remaining space`() = runComposeUiTest {
        val control = DiscreteGridControl()
        setContent {
        ...
        val centerBounds = onNodeWithTag("center").getUnclippedBoundsInRoot()
        ...
        fun assertLeft(tag: String, expected: Float) {
            val actual = onNodeWithTag(tag).getUnclippedBoundsInRoot().left.value
